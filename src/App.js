...
function App() {
  ...
  const [feedback, setFeedback] = useState("Will it mint?");
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Will it mint???????????");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0xFd40a8207C530f7A6fc893fe5F95889E305C3903",
      ...
      .then((receipt) => {
        setFeedback(
          "Minted! Visit Opensea.io to view your randomly generated NFT!"
        );
        setClaimingNft(false);
            ...
            {Number(data.totalSupply) == 10000 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still buy and trade WIM NFTs on{" "}
                  <a
                    target={""}
                    href={"https://opensea.io/collection/willitmint"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
